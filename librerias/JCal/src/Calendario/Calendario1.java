 ...
 * @version 1.0
 */
public class Calendario1 extends JPanel implements ActionListener{
    /**
    ...
    public Calendario1(JTextField fechaEditada){
    ...
    public void actionPerformed(ActionEvent e) {
        for (int i = CERO; i < diasDelMes.botonDia.length; i++){
            if (e.getSource() == diasDelMes.botonDia[i]){
                ...
                fechaEd.setText(fecha.getText().substring(24,28) +
                                fecha.getText().substring(4,7)   +
                                fecha.getText().substring(8,10));
                //dispose();
            }
        }
