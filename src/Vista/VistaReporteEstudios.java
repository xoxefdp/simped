...
import Vista.Componentes.ReporteConstanciaEstudios;
 ...
 * @author josediaz
 */
public class VistaReporteEstudios extends JFrame {
    ...
    final void crearGui(){
        setTitle("Emision de Constancia de Estudios");
        setResizable(false);
    ...
    */    
    ...
    public void imprimir() {
        if (tablaGradoFechaAlumnos.tabla.getSelectedRow()>=0){
            ...
            String stringCodEstudiante=(String)tablaGradoFechaAlumnos.tablaModelo.getValueAt(tablaGradoFechaAlumnos.tabla.getSelectedRow(), 1); //string
            int codigoEstudiante=Integer.parseInt(stringCodEstudiante);    //   int
            
            int codigoGrado = Integer.parseInt(getCodigoGrado());
            
            ResultSet resultadoConsultaEstudiante = alumnoGrado.consultarAlumnoGradoFecha(getFecha(), codigoGrado, codigoEstudiante);
                       
            ReporteConstanciaEstudios reporteConstanciaEstudiante = new ReporteConstanciaEstudios(resultadoConsultaEstudiante);
